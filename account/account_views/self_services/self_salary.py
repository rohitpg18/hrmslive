...
class SalarySlip(View):
    ...
    def get (self, request, pk):
        ...
        additional_details = UserAdditionalDetail.objects.get(emp_user_id=emp_id)
        
        user_sal = Decimal(basic_details.salary)
        month_format = salary_details.month.month_name[0:-4] + ' ' + salary_details.month.month_name[-4:]
