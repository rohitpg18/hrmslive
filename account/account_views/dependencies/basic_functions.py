...
def is_profile_complete(user_id,**kwargs):
    ...
    if user_detail is not None:
        ...
        if user_detail["basic_detail"].is_verify or user_detail["basic_detail"].is_requested:
            ...
            elif user_detail["previous_organisation_detail"][0].is_completed_previous_organisation_details == False and user_detail["basic_detail"].experience_status == "Experienced":
...
def month_attendance_counter (user_id, month_name = 0):
    ...
    if month_full_day_sl_leaves == 0:
        ...
        month_sl_count = Decimal(month_full_day_sl_leaves - (month_half_day_sl_leaves * 0.5))
    ...
    if month_full_day_pl_leaves == 0:
        ...
        month_pl_count = Decimal(month_full_day_pl_leaves - (month_half_day_pl_leaves * 0.5))
    ...
    if month_full_day_cl_leaves == 0:
        ...
        month_cl_count = Decimal(month_full_day_cl_leaves - (month_half_day_cl_leaves * 0.5))
    ...
    if month_full_day_lop_leaves == 0:
        ...
        month_lop_count = Decimal( month_full_day_lop_leaves - (month_half_day_lop_leaves * 0.5))
